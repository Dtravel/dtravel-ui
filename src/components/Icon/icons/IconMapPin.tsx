...
const IconMapPin: React.FC<IconProps> = ({ width = 16, height = 16, color = 'none' }) => {
  return (
    <svg width={width} height={height} viewBox="0 0 16 18" fill={color} xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M8 9.66663C9.10457 9.66663 10 8.7712 10 7.66663C10 6.56206 9.10457 5.66663 8 5.66663C6.89543 5.66663 6 6.56206 6 7.66663C6 8.7712 6.89543 9.66663 8 9.66663Z"
        stroke="black"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
